import { Text, Button, StyleSheet, View, ActivityIndicator, SafeAreaView, Image, Dimensions, Animated, Keyboard, TextInput, UIManager, Platform } from 'react-native';
...
class LoginScreen extends React.Component {
    ...
    renderButtonOrLoading() {
        ...
        return <Button onPress={this.onSignInPress.bind(this)} title="Log in" color={'#303338'} />;
    }
    ...
    render() {
        return (
            <SafeAreaView style={styles.container} forceInset={{ bottom: 'never' }}>
                <Animated.View style={{ transform: [{translateY: this.state.shift}], alignItems: 'center'}}>
