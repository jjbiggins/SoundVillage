...
import {List, ListItem, Button, Overlay, SearchBar} from 'react-native-elements'
        ...
        if (this.state.loading){
            ...
            return (
                <SafeAreaView style={styles.container}>
                    ...
                    <FlatList style={{position: 'absolute', bottom: 90, top: 10, right: 0, left: 0}}
            ...
            return (
                <SafeAreaView style={styles.container}>
                    ...
                    <FlatList style={{position: 'absolute', bottom: 0, top: 10, right: 0, left: 0}}
                              data={this.state.playlists}
                              renderItem={({ item }) =>
                                  <ListItem
                                      Component={TouchableScale}
