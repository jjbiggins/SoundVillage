...
import {Text, StyleSheet, ActivityIndicator, FlatList, Alert, SafeAreaView, Platform} from 'react-native';
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <ListItem
                            ...
                            rightIcon={<Icon name={'plus'} color={'#303338'} size={25} onPress={() => Alert.alert(
                    ...
                    ListEmptyComponent={() => (
                        <Text style={{textAlign: 'center', margin: 30}}>No songs</Text>
                    )}
                />
            </SafeAreaView>
        );
